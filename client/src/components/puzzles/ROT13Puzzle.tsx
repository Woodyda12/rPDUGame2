  ...
  return (
    <div className="border border-purple-500 p-2 bg-black bg-opacity-90 rounded hover:bg-opacity-100 transition-all duration-200 cursor-pointer">
      ...
      <input
        ...
        className="w-16 px-1 text-purple-400 text-sm bg-black border border-gray-600 font-mono hover:border-purple-500 transition-colors duration-200 cursor-text"
        placeholder="???"
      />
